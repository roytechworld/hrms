...
/**
 * The persistent class for the vms_admin_payment_master database table.
 * 
 */
@Entity
@Table(name="vms_admin_payment_master")
@NamedQuery(name="VmsAdminPaymentMaster.findAll", query="SELECT v FROM VmsAdminPaymentMaster v")
public class VmsAdminPaymentMaster implements Serializable {
