...
/**
 * The persistent class for the vms_consultant_files database table.
 * 
 */
@Entity
@Table(name="vms_consultant_files")
@NamedQuery(name="VmsConsultantFile.findAll", query="SELECT v FROM VmsConsultantFile v")
public class VmsConsultantFile implements Serializable {
