...
/**
 * The persistent class for the vms_vendor_master database table.
 * 
 */
@Entity
@Table(name="vms_vendor_master")
@NamedQuery(name="VmsVendorMaster.findAll", query="SELECT v FROM VmsVendorMaster v")
public class VmsVendorMaster implements Serializable {
