	...
	<div class="container mid">
    	<div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
                ...
                <p class="login-box-msg">Insert Your OTP  </p>
            
                 <form id="frm" action="otpvalidate" method="post">
                  <div class="form-group has-feedback">
                  
                    <input type="text" id="email" name="otp" class="form-control" placeholder="OTP">
               ...
               <div id="isa_error" class="isa_error">
                  ...
                  <div class="row">
                    ...
                    <!-- /.col -->
                    <div class="col-xs-4">
                      <button id="btOTPValidate" class="btn btn-success btn-block btn-flat">Send</button>
                    </div>
